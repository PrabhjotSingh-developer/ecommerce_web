...
console.log(modal)
  return (
    <Layout >
      <div className="py-36 md:py-52 lg:py-32 bg-gray-100  relative "  style={{ backgroundColor: mode === 'dark' ? '#282c34' : '', color: mode === 'dark' ? 'white' : '', }} onClick={closeModal}>
